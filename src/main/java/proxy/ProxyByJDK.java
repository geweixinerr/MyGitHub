...
public final class ProxyByJDK {
	...
	public static TransCashIntf getInstance(TransCashIntf intf) {
		TransCashIntf instance = (TransCashIntf) Proxy.newProxyInstance(ProxyByJDK.class.getClassLoader(), new Class[]{ TransCashIntf.class }, new InvocationHandler() {
			@Override
